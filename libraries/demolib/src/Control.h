#ifndef __CControl_h_
#define __CControl_h_
...
class CControlPanelCollection
{
public:

    CControlPanelCollection();
    ~CControlPanelCollection();

    CControlPanel* AddControlPanel(char *pName="", int iPosH=0, int iPosV=0, int iSizeH=0, int iSizeV=0);

    bool Mouse(int Button, int State, int x, int y);
	bool Motion(int iX, int iY);
	bool PassiveMotion(int iX, int iY);

    CControlPanel* GetCurrentPanel();

	void Display(void);

public:
    int m_iCurrentPanel;
    vector<CControlPanel*> m_vControlPanels;
...
{
public:
	CControlPanel(char *pName="", int iPosH=0, int iPosV=0, int iSizeH=0, int iSizeV=0);
	~CControlPanel();
