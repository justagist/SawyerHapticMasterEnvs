...
CFcsGLWorkspace::CFcsGLWorkspace( float fRadiusMin, 
                            float fRadiusMax, 
                            float fCenterOffset, 
                            float fPhiMin,
                            float fPhiMax,
...
CFcsGLWorkspace::~CFcsGLWorkspace()
{
...
void CFcsGLWorkspace::CreateVertices(void)
{
...
void CFcsGLWorkspace::Display(unsigned char ucMode)
{
...
void CFcsGLWorkspace::DisplayBottom(bool bGrid)
{
...
void CFcsGLWorkspace::DisplayTop(bool bGrid)
{
    glVertexPointer(3, GL_FLOAT, 0, m_pPlaneVertices);
    glNormalPointer(GL_FLOAT, 0, m_pPlaneNormals);
...
void CFcsGLWorkspace::DisplayLeft(bool bGrid)
{
...
void CFcsGLWorkspace::DisplayRight(bool bGrid)
{
    glVertexPointer(3, GL_FLOAT, 0, m_pSideVertices);
    glNormalPointer(GL_FLOAT, 0, m_pSideNormals);
...
void CFcsGLWorkspace::DisplayBack(bool bGrid)
{
...
void CFcsGLWorkspace::Display2(bool bGrid)
{
...
void CFcsGLWorkspace::DisplayAxes()
{
